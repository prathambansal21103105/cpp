...
int get(string num){
    int temp1=0;
    int temp2=0;
    temp1=((num[0]-'0')*10)+(num[1]-'0');
    temp2=((num[3]-'0')*10)+(num[4]-'0');
    return (temp1*60)+temp2;
}
void func(string& st11, string& st22, string& diff11, string& diff22){
    int st1,st2,diff1,diff2;
    st1=get(st11);
    st2=get(st22);
    diff1=get(diff11);
    diff2=get(diff22);
    // cout<<st1<<" "<<diff1<<endl;
    // cout<<st2<<" "<<diff2<<endl;
    // st1+(n*diff1)=st2+(m*diff2);
    // n*diff1=st2-st1+(m*diff2);
    // n=(st2-st1+(m*diff2))/diff1;
    int range=(10080-st2)/diff2;
    int ans=-1;
    for(int i=0;i<range+1;i++){
        if((st2-st1+(i*diff2))%diff1==0){
            ans=st2+(i*diff2);
            break;
        }
    }
...
void solve(){
    string st1,st2,diff1,diff2;
    cin>>st1>>st2>>diff1>>diff2;
    // cout<<st1<<endl;
    // cout<<st2<<endl;
    // cout<<diff1<<endl;
    // cout<<diff2<<endl;
    func(st1,st2,diff1,diff2);
}
int main()
{
    fast_cin();
